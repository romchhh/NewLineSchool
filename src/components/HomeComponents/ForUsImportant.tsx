      ...
      <div className="home-for-us-important-container">
        ...
        <div className="home-for-us-important-content">
          ...
          <div className="home-for-us-important-text-container">
            ...
            <HighlightedTextWithDots colorBackground="#BFA0BEB2" colorDots="#AE88AD" colorText="#414040" widthDots={5} widthBorder={1}>Впевнено спілкуватися</HighlightedTextWithDots>: вільно спілкуватися в повсякденному житті, подорожувати та будувати міжнародну кар’єру.
            </div>
            <div className="home-for-us-important-text">
            <HighlightedTextWithDots colorBackground="#A0BFBD66" colorDots="#A0BFBD" colorText="#414040" widthDots={5} widthBorder={1}>Скласти міжнародні іспити</HighlightedTextWithDots>: успішно підготуватися до Cambridge Exams, НМТ та  ЄВІ.
            </div>
            <div className="home-for-us-important-text">
            <HighlightedTextWithDots colorBackground="#FCE69699" colorDots="#FCE696" colorText="#414040" widthDots={5} widthBorder={1}>Досягти академічних успіхів</HighlightedTextWithDots>: легко розуміти навчальний матеріал та ефективно спілкуватися з викладачами
            </div>
          </div>
        </div>
      </div>
