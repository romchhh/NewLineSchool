...
export default function Footer({background}: {background: boolean}) {
    ...
    return <div className="footer-container" style={{backgroundImage: background ? "url('./assets/background/back-footer.png')": "none", paddingTop: background ? 80 : 0, height: background ? (layoutForMainBanner !== "mobile" ? 400: "auto"):(layoutForMainBanner !== "mobile" ? 350: "auto")}}>
